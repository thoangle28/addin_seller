...
const TicketsList = () => {
    ...
    const [ticketsListing, setTicketsListing] = useState<any>({})
		const [ticketInfo, setTicketInfo] = useState<props>({totalTicket: 0, totalPages: 0, currentPage: 0, pageSize: 0, status: ''})	
															...
															<div className='d-flex justify-content-between align-items-center flex-wrap panigation'>
																<div className='d-flex align-items-center py-3'>                   
																	...
																	<span className='text-muted ms-5'>
																		Displaying {ticketInfo.currentPage} of {ticketInfo.totalPages} pages
																	</span>
																	{ isPaginate &&
																		...
																		listPages &&
																			listPages.map((item: any,index: number) => {
																				...
																				href={'#' + item.page} onClick={() => {
																						setPaginate(true)
																						onChangePage(ticketInfo.pageSize, item.page) 
																					}
																				}
