...
import { GetTicketsListing } from './supportApi';
import { useReducer } from "react";

const TicketsList = () => {

    const [loading, setLoading] = useState(true)
    const [ticketsListing, setTicketsListing] = useState([])
    ...
    const onChangePage = (pageSize: number = 10, currentPage: number = 1) => {
        ...
        const ticketsLisitng = GetTicketsListing(initialParams)
        setLoading(true)
        ticketsLisitng.then((data: any) => {
            console.log(data)
            setTicketsListing(data)
            setLoading(false)
        })        
                        ...
                        <div className="me-4 my-1">
                            <div className="d-flex align-items-center position-relative my-1 status-product">
                                <select name="business_type" 
                                    ...
                                    data-control="select2" data-placeholder="Status" data-allow-clear="true" 
