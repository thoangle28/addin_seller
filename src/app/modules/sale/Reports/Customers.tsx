...
import { fetchCustomer, getCustomerListInput } from '../Redux/Actions'
...
const Customers = (props: Props) => {
    ...
    const onChangeHandler = (e: any, current_page: number = 1) => {
        ...
        dispatch(getCustomerListInput({ ...formCustomerValue, [name]: parseInt(value), current_page }))
    }
        ...
        <div className='col-xs-12'>
            <div className="table-responsive">
                {isLoading ? <Loading /> : <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
                    ...
                    {isEmptyObject(customerList).length ? <tbody>
